...
module.exports.CDN_URL = "https://hummus-cdn.sys42.net";
module.exports.CLIENT_URL = "https://hummus.sys42.net";
...
module.exports.GUILD_MEMBER_ROLE =                   (guildID, memberID) => `/guilds/${guildID}/members/${memberID}`; 
