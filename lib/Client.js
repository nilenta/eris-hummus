...
class Client extends EventEmitter {
    ...
    */
    addGuildMemberRole(guildID, memberID, roleID) {
		//console.log(Endpoints.GUILD_MEMBER_ROLE(guildID, memberID, roleID))
        /*return this.requestHandler.request("PUT", Endpoints.GUILD_MEMBER_ROLE(guildID, memberID, roleID), true, {
            reason
        });*/
		return this.requestHandler.request("PATCH", Endpoints.GUILD_MEMBER_ROLE(guildID, memberID), true, JSON.parse(`{"roles":["${roleID}"]}`));
    }
